...
<head>
    ...
    <title>Artile-JMIvecospace</title>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            ...
                            <div>
                                <strong>
                                    Total: {{ !empty($articlelist) ? count($articlelist) : 0 }}
                                </strong>
                            </div>
                        </div>
                    </div>
                                            ...
                                            @if (!empty($articlelist) && count($articlelist) > 0)
                                                @foreach ($articlelist as $index => $article)
                                                    <tr>
                                                        ...
                                                        <?php
                                                        // Clean the post title for URL
                                                        $postTitle = substr(preg_replace('/[^A-Za-z0-9\-]/', '-', str_replace(' ', '-', strip_tags(trim(strtolower($article['PostTitle']))))), 0, 100);
                                                        ?>
                                                        <td align="center" valign="top" class="graylist">
                                                            <a href="<?php echo $websiteurl; ?>articles-and-trivia/<?php echo encodeStr($article['id']); ?>/<?php echo $postTitle; ?>.html"
