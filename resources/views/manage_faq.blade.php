                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <!-- Top Add Page Button -->
                                    <button class="btn btn-success mb-3" data-toggle="modal" data-target="#addFaqModal">
                                        Add New FAQ Page
                                    </button>
                                    ...
                                    <div class="modal fade" id="addFaqModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <form method="POST" action="{{ route('faqpages_createed') }}">
                                                @csrf
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Add New FAQ Page</h5>
                                                            ...
                                                            <div class="modal-dialog modal-dialog-centered"
                                                                ...
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <form
                                                                            action="{{ route('faqpagesstatus.update') }}"
                                    ...
                                    <div class="modal fade" id="editFaqModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog modal-lg" role="document">
                                            <form id="editFaqForm" method="POST"
                                                action="{{ route('faqpages.update') }}">
                                                @csrf
                                                <input type="hidden" name="id" id="editFaqId">

                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title">Edit FAQ Page</h5>
                                                        <button type="button" class="close"
                                                            data-dismiss="modal">&times;</button>
                                                    </div>
                                                        ...
                                                        <div class="container-fluid">
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-3">
                                                                    <label>Title</label>
                                                                    <input type="text" class="form-control"
                                                                        name="title" id="editFaqTitle" required>
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                    <label>Description</label>
                                                                    <textarea class="form-control" name="txtDescription" id="editFaqDescription" rows="2"></textarea>
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                    <label>Meta Title</label>
                                                                    <input type="text" class="form-control"
                                                                        name="meta_title" id="editFaqMetaTitle">
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                    <label>Meta Description</label>
                                                                    <textarea class="form-control" name="meta_description" id="editFaqMetaDescription" rows="2"></textarea>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="form-row">
                                                                <div class="form-group col-md-3">
                                                                    <label>Meta Keyword</label>
                                                                    <input type="text" class="form-control"
                                                                        name="meta_keyword" id="editFaqMetaKeyword">
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                    <label>Status</label>
                                                                    <select class="form-control" name="status"
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    <label>Backpage</label>
                                                                    <input type="text" class="form-control"
                                                                        name="backpage" id="editFaqBackpage">
                                                                </div>
                                                                <div class="form-group col-md-3">
                                                                    <label>Type</label>
                                                                    <input type="text" class="form-control"
                                                                        name="type" id="editFaqType"
                                                                        value="faq" readonly>
                                                                </div>
                                                            </div>
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            $('.edit-btn').on('click', function() {
                                                ...
                                                $('#editFaqId').val(id);
                                                $('#editFaqTitle').val(title);
                                                $('#editFaqDescription').val(description);
                                                $('#editFaqMetaTitle').val(meta_title);
                                                $('#editFaqMetaDescription').val(meta_description);
                                                $('#editFaqMetaKeyword').val(meta_keyword);
                                                $('#editFaqStatus').val(status);
                                                $('#editFaqBackpage').val(backpage);
                                                $('#editFaqType').val('faq'); // Ensure type is always 'faq'
        ...
        $(document).ready(function() {
            $('.delete-btn').on('click', function() {
                ...
                if (confirm('Are you sure you want to delete this page?')) {
                    $.ajax({
                        url: '{{ route('faqpages.delete') }}', // route to delete action
                        ...
                        success: function(response) {
                            alert(response.message || 'Faqs Page deleted successfully.');
