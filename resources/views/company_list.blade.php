...
<head>
    ...
    <title>Company-SGTvecospace</title>
                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 text-right">
                            ...
                            <div>
                                <strong>
                                    Total: {{ !empty($companylist) ? count($companylist) : 0 }}
                                </strong>
                            </div>
                                ...
                                <div class="card-body">
                                    <table id="example2" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                data-toggle="modal"
                                                                data-target="#statusModal{{ $company['id'] }}">
                                                                @if ($company['status'] == 0)
                                                            ...
                                                            <div class="modal fade"
                                                                id="statusModal{{ $company['id'] }}" tabindex="-1"
                                                                role="dialog"
                                                                aria-labelledby="statusModalLabel{{ $company['id'] }}"
                                                                aria-hidden="true">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title"
                                                                                id="statusModalLabel{{ $company['id'] }}">
                                            ...
                                            @else
                                                <tr>
                                                    <td colspan="7" class="text-center text-danger">🚫 No Companies
                                                        Found</td>
                                                </tr>
                                            @endif
                                        </tbody>
